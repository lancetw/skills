...
w_emoji = EMOJI.get(code, '🌤️')
wind_desc = '風大' if wind >= 30 else ('微風' if wind >= 15 else '無風')
...
t_emoji = EMOJI.get(t_code, '🌤️')
tm_code = dy.get('weather_code', [0,0])[1]
tm_emoji_raw = EMOJI.get(tm_code, '🌤️')
...
print('\n\n\n' + _json.dumps(output, ensure_ascii=False))
