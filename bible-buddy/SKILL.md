...
6. **Denomination-specific?** — Check `references/denomination-claims.md` (37 denominations) for pre-verified analysis of this denomination's claims.
7. **Common misread?** — Check `references/commonly-misread-passages.md` (45 passages) for pre-verified analysis if this passage is commonly taken out of context.
8. **Translation bias?** — Check `references/translation-bias.md` (15 verse-level + 7 systemic biases) for known Chinese translation issues. Flag when found.
